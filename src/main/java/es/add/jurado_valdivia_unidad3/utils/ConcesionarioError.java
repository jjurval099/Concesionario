package es.add.jurado_valdivia_unidad3.utils;
 ...
 */
public class ConcesionarioError extends Exception
{
	/**
	 * Serial Version UID
	 */
	 ...
	 */
	public ConcesionarioError(int code, String message) 
	{
		super(message);
	 ...
	 */
	public ConcesionarioError(int code, String message, Exception exception) 
	{
